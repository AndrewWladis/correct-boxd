  ...
  return (
    <a href={`/movie/${info._id}`}>
      ...
      <div className="w-full h-full flex justify-center items-center">
        <Image loader={() => info.poster} loading="lazy" src={info.poster} alt={info.title} width={164} height={230} style={{maxHeight: 230, minHeight: 230}} className="rounded-2xl object-cover  bg-change" />
      </div>
